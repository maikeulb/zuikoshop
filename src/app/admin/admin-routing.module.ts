...
import { AdminCatalogItemFormComponent } from './admin-catalog/admin-catalog-item-form.component';
...
const routes: Routes = [
  {
    ...
    children: [
      { path: 'catalog/new',
        component: AdminCatalogItemFormComponent,
